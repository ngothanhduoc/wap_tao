 ...
 * @property StoreDevice $StoreDevice
 * @property RabbitMQ $RabbitMQ
 * @property Crypt $crypt
 * @property SupportDeviceId $SupportDeviceId
 * @property SMSHandle $SMSHandle
 * @property ConfigModel $ConfigModel
 * @property MoboAPI $MoboAPI
 * @property Curl $Curl
 * @property Monitor $Monitor
 * @property UserAPI $UserAPI
 * @property GAPI $GAPI
 * @property InsideModel $InsideModel
 * @property ServiceAPI $ServiceAPI
 * @property BigDataAPI $BigDataAPI
 * @property AppOneAPI $AppOneAPI
 * @property ReportModel $ReportModel
 * @property MongoAPI $MongoAPI
 *
