...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 29, 2015 at 03:50 AM
...
(2, 'Game Bắn Súng', NULL, 'Game mới', 0, '2015-07-15 15:43:08', '2015-07-15 22:31:46'),
...
`id_game_app` int(11) NOT NULL,
  ...
  `order` int(11) DEFAULT NULL,
  `set_slide` enum('active','block') DEFAULT 'block'
...
--
ALTER TABLE `game_app`
MODIFY `id_game_app` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
