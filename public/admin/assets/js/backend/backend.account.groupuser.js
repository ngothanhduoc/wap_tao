...
var arrCat = [];
var BACKEND = {
    API_URL_LIST: '/backend/list/user_group',
    AJAX_URL_DELETE: '/backend/ajax/delete/admin_account/groupuser/user_group/id_group',
    AJAX_URL_UPDATE: '/backend/ajax/updatestatus/admin_account/groupuser/user_group/id_group',
    ...
    dataAdapter: function() {
        ...
        var dataAdapter = new $.jqx.dataAdapter(source, {
           beforeLoadComplete: function (records) {
                ...
                records[i].idStatus = records[i].id_group + ',' + records[i].status;					
    ...
    toolscolumnrender: function(row, datafield, value) {
        return '<div class="grid-tools"><a href="javascript:void(0)" onclick="BACKEND.gridEdit(' + value + ');return false;" class="grid-tools"><span class="ui-icon ui-icon-pencil"></span></a><!--<a href="javascript:void(0)" onclick=""><span class="ui-icon ui-icon-trash"></span></a>--></div>';
    },
    ...
    init: function() {
		...
		{text: 'Status', datafield: 'idStatus', cellsrenderer: BACKEND.statuscolumnrender, width: 40,filterable: false, sortable: false},
                {text: 'Công cụ', datafield: 'id_group', cellsalign: 'center', align: 'center', cellsrenderer: BACKEND.toolscolumnrender, width: 80, sortable: false, filterable: false},
            ],
            virtualmode: true,
    ...
    gridEdit: function(id) {
        //loadPopup(id, false);
        window.location.href = '/backend/account/addgroupuser?id=' + id;
    },
    setBc: function(id){
        $.ajax({
