...
var arrCat = [];
var BACKEND = {
    API_URL_LIST: '/backend/ajax/listhistory/action_event',
    API_URL_TOTAL: '/backend/ajax/totalhistory/action_event',
    OBJ_GRID: null,
    dataAdapter: function() {
        ...
        var source = {
            datatype: "jsonp",
            datafields: [
                {name: 'id_action_event', type: 'int'},
                {name: 'game_app', type: 'int'},
                {name: 'user_id', type: 'int'},
                {name: 'type', type: 'string'}, 
                {name: 'platform', type: 'string'}, 
                {name: 'icoin', type: 'string'},                 
        ...
        var dataAdapter = new $.jqx.dataAdapter(source, {
            beforeLoadComplete: function(records) {
                ...
                for (var i = j; i < records.length; i++) {
                    records[i].idCoppy = records[i].id_action_event;
                    records[i].game_name = arrGame[records[i].game_app];
                }
                ;
    ...
    init: function() {
        ...
        BACKEND.OBJ_GRID.jqxGrid({
            ...
            columns: [
                ...
                {text: 'GAME APP', datafield: 'game_name'},
