...
var arrCat = [];
var BACKEND = {
    API_URL_LIST: '/backend/list/codes',
	...
	desable: function(id){
        $.ajax({
                url: BACKEND.AJAX_URL_UPDATE + '?id=' + id + '&st=0&field=status&kk='+Math.random(),
                type: 'GET',
                dataType: 'JSON',
                data: {}
            }).done(function(response) {
	...
	enable: function(id){
        $.ajax({
                url: BACKEND.AJAX_URL_UPDATE + '?id=' + id + '&st=1&field=status&kk='+Math.random(),
                type: 'GET',
                dataType: 'JSON',
                data: {}
            }).done(function(response) {
