...
var arrCat = [];
var BACKEND = {
    API_URL_LIST: '/backend/ajax/listhistory/change_gift',
    OBJ_GRID: null,
    dataAdapter: function() {
        ...
        var source = {
            datatype: "jsonp",
            datafields: [
                {name: 'id_change_gift', type: 'int'},
                {name: 'user_id', type: 'int'},
                {name: 'device_id', type: 'int'},
                {name: 'type', type: 'string'}, 
                {name: 'serial', type: 'string'}, 
                {name: 'pin', type: 'string'}, 
                {name: 'telco', type: 'string'}, 
    ...
    init: function() {
        ...
        BACKEND.OBJ_GRID.jqxGrid({
            ...
            columns: [
                ...
                {text: 'SERIAL', datafield: 'serial'},
                {text: 'PIN', datafield: 'pin'},
                {text: 'TELCO', datafield: 'telco'},
