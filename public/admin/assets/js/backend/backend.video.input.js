...
var BACKEND = {
    AJAX_URL_COMMIT: '/backend/ajax/addvideo',
    commit: function() {
    ...
    init: function() {
//        BACKEND.initDropdownlistType(TYPE, source_db);
    ...
    initDropdownlistType: function(data, source_db) {
        var source = source_db;
        $("#jqxDropdownlistType").jqxDropDownList({checkboxes: false, source: source, selectedIndex: 1, width: '100%', height: '25', theme: THEME, placeHolder: "Vui lòng chọn"});
