...
var BACKEND = {
        ...
        var dataAdapter = new $.jqx.dataAdapter(source, {
            beforeLoadComplete: function (records) {
                ...
                for (var i = j; i < records.length; i++) {
                    ...
                    records[i].qgName = quocgiaName[records[i].id_country];
                    records[i].numGame = arrNum[records[i].id_publisher];
                };
    ...
    init: function() {
		...
		{text: 'CREATE TIME', datafield: 'create_time'},
                {text: 'COUNTRY ID', datafield: 'id_country'},
                {text: 'COUNTRY NAME', datafield: 'qgName', sortable: false, filterable: false},
                {text: 'NUM GAME', datafield: 'numGame', sortable: false, filterable: false},
