...
//                    }
                    ...
                    $menu = $this->m_account->get_menu_by_group(json_decode($info['permission'],true));
                    ...
                    $_SESSION['KCFINDER']['uploadURL'] = '../../../assets/images/' . md5($info['username']);
                    $_SESSION['KCFINDER']['uploadDir'] = '../../../assets/images/' . md5($info['username']);

                    $path = FCPATH . 'assets/images/' . md5($info['username']) . '/images';
                    if (!file_exists($path)) {
