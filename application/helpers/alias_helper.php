...
function utf8_to_ascii($str = '') {
    ...
    $chars = array
        ...
        'n' => array('n'),
        'i' => array('i', 'í', 'ì', 'ỉ', 'ị', 'ĩ'),
        'o' => array('o', 'ó', 'ò', 'ỏ', 'õ', 'ọ', 'ỡ', 'ơ', 'ớ', 'ờ', 'ở', 'ợ', 'ô', 'ố', 'ồ', 'ổ', 'ộ', 'ỗ'),
        'u' => array('u', 'ú', 'ù', 'ủ', 'ũ', 'ụ', 'ú', 'ư', 'ứ', 'ừ', 'ử', 'ữ', 'ự'),
        'y' => array('y', 'ý', 'ỳ', 'ỵ', 'ỷ', 'ỹ'),
        'q' => array('q'),
        'w' => array('w'),
        'r' => array('r'),
...
function convert($text = NULL, $type = NULL) {
    switch ($type) {
        case 'upper': $html = mb_convert_case($text, MB_CASE_UPPER, 'utf-8');
            break;
        case 'title': $html = mb_convert_case($text, MB_CASE_TITLE, 'utf-8');
            break;
        default: $html = mb_convert_case($text, MB_CASE_LOWER, 'utf-8');
            break;
    }
    return $html;
}
