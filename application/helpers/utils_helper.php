...
function get_like_share_count(){
    $link = 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
    $url = "http://api.facebook.com/restserver.php?method=links.getStats&urls=".$link."&format=json";
    $data_link_share = @file_get_contents($url);
