...
class Breadcrumb{
	...
	private $separator = ' &nbsp; <img src="/frontend/assets/images/ico_next.png" style="vertical-align:middle" /> &nbsp; ';
		...
		if ($this->breadcrumbs) {
			...
			foreach ($this->breadcrumbs as $key => $crumb) {
				...
				if (end(array_keys($this->breadcrumbs)) == $key) {
                                    if($crumb['isLink'])
                                        $output .= '<a style="font-weight: bold; text-transform:uppercase" href="' . $crumb['href'] . '">' . $crumb['title'] . '</a>';
                                    else
