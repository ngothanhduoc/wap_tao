...
<div class="left">
	<h1 class="logo">APP.<span>ICOIN</span></h1>
	<span class="slogan">Inside,...</span>
	<!--
	<div class="search">
...
<div class="right">
	<div class="userinfo">
		<img src="/admin/assets/images/thumbs/avatar.png" alt="" />
		<span><?php echo ucfirst($user['username']);?></span>
	</div><!--userinfo-->
	
	<div class="userinfodrop">            	
		<div class="avatar">
			<a href=""><img src="/admin/assets/images/thumbs/avatarbig.png" alt="" /></a>
		</div><!--avatar-->
		<div class="userdata">
                ...
                <div id="contentwrapper" class="contentwrapper lineheight21">
                    <form class="stdform stdform2" id="frm-change-pass" role="form" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <p class="stdformbutton">
                             <button class="submit radius2" type="submit">Change</button>&nbsp;&nbsp;<span id="loading" style="position: absolute; display: none"><img src="/admin/assets/images/loaders/loader10.gif"/></span>
                        </p>
                    </form>
                </div>
            </div>
