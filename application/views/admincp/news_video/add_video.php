<script type="text/javascript">
    ...
    setActiveSubMenu('backend-news_video-add_video');
</script>

<script type="text/javascript" src="/admin/editor/ckeditor/ckeditor.js"></script>

<script type="text/javascript" src="/admin/assets/js/backend/backend.video.input.js?v=09072015"></script>
...
<div class="pageheader notab" style="border-bottom: none">
    ...
    <ul class="hornav">
        <li class="current"><a href="#info-game">Thông tin Video</a></li>        
    </ul>
</div><!--pageheader-->
    ...
    <div id="info-game" class="subcontent" style="display: block">
        <form class="stdform stdform2" id="frm-add-game" role="form" action="" method="POST" enctype="multipart/form-data">
            ...
            <p style="border-top: #ddd solid 1px; border-bottom: none">
                ...
                <span class="field">
                    <input type="text" placeholder="" id="name" name="name"  value="<?php echo @$data['name'] ?>">                    
                </span>
            </p>
            <p style="border-top: #ddd solid 1px; border-bottom: none">
                <label for="icon">ID Youtube <span style="color:#ff0000">(*)</span></label>
                <span class="field">
                    <input type="text" placeholder="" id="youtube_id" name="youtube_id" class="mediuminput" value="<?php echo @$data['youtube_id'] ?>" >
...
<!--            <div style="border: #ddd solid 1px; border-bottom: none">
            ...
            <p style="border-top: #ddd solid 1px;">
