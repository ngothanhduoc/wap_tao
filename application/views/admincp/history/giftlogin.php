<script type="text/javascript">
    ...
    setActiveSubMenu('backend-history-giftlogin');
...
<script type="text/javascript" src="/admin/assets/js/backend/backend.history.giftlogin.js?v=1"></script>
<div class="pageheader notab">
	<h1 class="pagetitle">Gift Login</h1>
