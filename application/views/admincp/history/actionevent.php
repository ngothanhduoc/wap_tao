<script type="text/javascript">
    ...
    setActiveSubMenu('backend-history-actionevent');
...
<script type="text/javascript" src="/admin/assets/js/backend/backend.history.actionevent.js?v=13072015"></script>
<div class="pageheader notab">
	<h1 class="pagetitle">Action Event</h1>
