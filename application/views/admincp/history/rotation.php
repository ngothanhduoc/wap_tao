<script type="text/javascript">
    ...
    setActiveSubMenu('backend-history-rotation');
...
<script type="text/javascript" src="/admin/assets/js/backend/backend.history.rotation.js?v=1"></script>
<div class="pageheader notab">
	<h1 class="pagetitle">Lịch sử quay số</h1>
