<script type="text/javascript">
    setActiveMenu('listitems');
    setActiveSubMenu('backend-listitems-add');
</script>

<script type="text/javascript" src="/admin/assets/js/backend/backend.listitems.input.js?v=3"></script>
...
<div class="pageheader notab" style="border-bottom: none">
    <h1 class="pagetitle">Add Tỷ giá</h1>
    <span class="pagedesc"></span>
    <ul class="hornav">
        <li class="current"><a href="#info-game">Add Tỷ giá</a></li>        
    </ul>
</div><!--pageheader-->
...
<div id="contentwrapper" class="contentwrapper lineheight21">
    <div id="info-game" class="subcontent" style="display: block">
        <form class="stdform stdform2" id="frm-add-game" role="form" action="" method="POST" enctype="multipart/form-data">
            ...
            <p>
                <label for="value">Value <span style="color:#ff0000">(*)</span></label>
                <span class="field">
                    <input type="text" placeholder="" id="value" name="value" class="smallinput" value="<?php echo @$data['value'] ?>">                    
                </span>
            </p>
            ...
            <p class="stdformbutton">
                ...
                <button class="submit radius2" type="submit">Add</button>&nbsp;&nbsp;<span id="loading" style="position: absolute; display: none"><img src="/admin/assets/images/loaders/loader10.gif"/></span>
            </p>
        </form>
    </div>   
