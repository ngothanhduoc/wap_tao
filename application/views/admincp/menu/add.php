...
<script type="text/javascript" src="/admin/assets/js/backend/backend.menu.input.js"></script>
...
<div id="contentwrapper" class="contentwrapper lineheight21">
	<form class="stdform stdform2" id="frm-add-menu" role="form" action="" method="POST" enctype="multipart/form-data">
		...
		<p class="stdformbutton">
			...
			<button class="submit radius2" type="submit">Add Menu</button>&nbsp;&nbsp;<span id="loading" style="position: absolute; display: none"><img src="/admin/assets/images/loaders/loader10.gif"/></span>
		</p>
